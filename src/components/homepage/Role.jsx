  ...
  return (
    <section ref={forwardedRef} id="about" className="select-none flex my-20 md:my-[12%] py-10 flex-col items-center justify-center overflow-hidden nav-change" aria-label="">
      <div className="flex w-full items-center space-x-20">
        ...
        Specializing in creating uplifting digital experiences, I strive to inspire and foster connections with individuals by seamlessly blending development and design.
        </h1>
      </div>
    </section>
  );
